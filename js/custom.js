...
$('.mailchimpAjaaa').ajaxChimp({
    callback: mailchimpCallback,
    url: "https://tinyletter.com/helphelp" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
});
...
===  SUBSCRIPTION FORM          ====
=================================== */
$("#subscribeAsadsa").submit(function (e) {
    e.preventDefault();
